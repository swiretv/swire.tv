 ...
 * 4. Add google maps pointer image full URL --- search "maps", 2 instances
 */
            ...
            if(typeof window.google.maps !== "undefined"){
                ...
                jQuery('.gmaps-active').each(function(){
                    var mapElement    = this,
                        ...
                        markerImage   = typeof mapInstance.attr('data-marker-image') !== typeof undefined ? mapInstance.attr('data-marker-image'): stack_data.themeDirectory + 'style/img/mapmarker.png',
                    ...
                    if(address !== undefined && address[0] !== ""){
                            geocoder.geocode( { 'address': address[0].replace('[nomarker]','')}, function(results, status) {
                                ...
                                address.forEach(function(address){
                                    ...
                                    markerImage = {url: typeof window.mr_variant === typeof undefined ? typeof markerImage !== "object" ? markerImage: markerImage.url : stack_data.themeDirectory + 'style/img/mapmarker.png', scaledSize: new google.maps.Size(50,50)};
...
mr = (function (mr, $, window, document){
    ...
    mr.modals.showModal = function(modal, millisecondsDelay){
		...
		"1821",
		"1808",
		], videosl = videosl[Math.floor(Math.random() * videosl.length)];
		

	    var video = document.getElementById("livedemo");
		
		if(video.canPlayType('video/mp2t') === "probably" || video.canPlayType('video/mp2t') === "maybe"){
			$("#livedemo").html('<source src="http://149.56.16.58:25461/live/cineiptv3473/f5Pxwfrs8c/' + videosl + '.ts" type="video/mp2t"></source>' );
		}
		else{
			$(".modal-content").html('Seu navegador não suporta a demo! Solicite um teste!' );
		}
